...
class ResnetGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64, n_blocks=6, img_size=256, light=False):
        ...
        #self Attention
        self.self_attn = Self_Attn(ngf * mult)
    ...
    def forward(self, input):
        ...
        w, sat, attn_map = self.self_attn(x)
       # sat_weight = self.self_attn.parameters()
...
class Self_Attn(nn.Module):
    ...
    def forward(self, x):
        """
            inputs :
                x : input feature mapsB X C X W X H)(
            returns :
        ...
        # Out
        w = list(self.snconv1x1_attn.parameters())[0]
...
class Discriminator(nn.Module):
    def __init__(self, input_nc, ndf=64, n_layers=5):
        ...
        self.self_attn = Self_Attn(ndf*mult)
