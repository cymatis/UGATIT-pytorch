...
class Multi_Self_Attn(nn.Module):
    ...
    def __init__(self,in_dim,activation):
        ...
        self.query_conv_7 = nn.utils.spectral_norm(nn.Conv2d(in_channels = in_dim , out_channels = in_dim//8 , kernel_size= 7, stride=1, padding=3))
        self.key_conv_7 = nn.utils.spectral_norm(nn.Conv2d(in_channels = in_dim , out_channels = in_dim//8 , kernel_size= 7,  stride=1, padding=3))
        self.value_conv_7 = nn.utils.spectral_norm(nn.Conv2d(in_channels = in_dim , out_channels = in_dim , kernel_size= 7,  stride=1, padding=3))
